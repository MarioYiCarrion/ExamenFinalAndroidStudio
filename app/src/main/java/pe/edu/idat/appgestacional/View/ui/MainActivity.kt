package pe.edu.idat.appgestacional.View.ui
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Configurar el botón flotante para enviar un correo
        binding.appBarMain.fab.setOnClickListener {
            val emailIntent = Intent(Intent.ACTION_SEND).apply {
                type = "message/rfc822"
                putExtra(Intent.EXTRA_EMAIL, arrayOf("CapSurquillo@essalud.gob.pe"))
            ...
            if (emailIntent.resolveActivity(packageManager) != null) {
                ...
                Log.d("MainActivity", "No hay aplicaciones de correo disponibles")
                Snackbar.make(binding.root, "No hay aplicaciones de correo disponibles", Snackbar.LENGTH_LONG).show()
            }
        }
